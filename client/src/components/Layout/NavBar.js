import logo from "../../Assets/titan2.webp"
                ...
                <ul className='navbar-nav'>
                    ...
                    <ul class="dropdown-menu">
                    {
                      CategoryList.map((cat,index) => {
                        let loc = "http://localhost:3000/cat_wise/"+cat.category_name;
                    ...
                    <li className='nav-item'><a href='/mycart'  className='nav-link'> <i className='fa fa-shopping-cart text-dark fs-2'> </i>   </a></li>
                    <span className="badge bg-primary " style={{marginRight:"10px" , marginTop:"-10px"}} >{2}</span>
                    <li className='nav-item'><a href='/feed'  className='nav-link'>Feedback </a></li>
          ...
          <div className='container-fluid'>
              ...
              <ul className='navbar-nav'>
                ...
                <li className="nav-item dropdown">
                  ...
                  <li className='nav-item'><a href='/vieworder'  className='nav-link'> View Orders </a></li>
                  <li className='nav-item'><a href='/today'  className='nav-link'> Today's Order </a></li>
                  <li className='nav-item'><a href='/feedview'  className='nav-link'> Feedback </a></li>
                  <li className='nav-item'><button className='btn btn-danger' onClick={logout}> Logout </button> </li>
              </ul>
          </div>
      </nav>
      ...
      <nav className='navbar navbar-expand-sm bg-primary navbar-dark fw-bold text-white'>
            <div className='container-fluid'>
                ...
                <ul className='navbar-nav'>
                    ...
                    <li className='nav-item'><a href='/log'  className='nav-link'> Login </a></li>
